...
#ifndef __xillybus_wrapper_ibs_H__
#define __xillybus_wrapper_ibs_H__
...
struct xillybus_wrapper_ibs_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(xillybus_wrapper_ibs_ram) {
...
xillybus_wrapper_ibs_ram* meminst;


SC_CTOR(xillybus_wrapper_ibs) {
meminst = new xillybus_wrapper_ibs_ram("xillybus_wrapper_ibs_ram");
