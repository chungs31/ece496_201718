...
#ifndef __xillybus_wrapper_fYi_H__
#define __xillybus_wrapper_fYi_H__
...
struct xillybus_wrapper_fYi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(xillybus_wrapper_fYi_ram) {
...
xillybus_wrapper_fYi_ram* meminst;


SC_CTOR(xillybus_wrapper_fYi) {
meminst = new xillybus_wrapper_fYi_ram("xillybus_wrapper_fYi_ram");
