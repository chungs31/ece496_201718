...
#ifndef __xillybus_wrapper_ocq__HH__
#define __xillybus_wrapper_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(xillybus_wrapper_ocq) {
    ...
    SC_CTOR(xillybus_wrapper_ocq):  ACMP_smul_us_U ("ACMP_smul_us_U") {
