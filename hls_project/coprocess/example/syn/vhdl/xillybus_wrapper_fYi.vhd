...
entity xillybus_wrapper_fYi_rom is 
    generic(
             dwidth     : integer := 100; 
             awidth     : integer := 4; 
             mem_size    : integer := 13
...
architecture rtl of xillybus_wrapper_fYi_rom is 
...
architecture arch of xillybus_wrapper_fYi is
    component xillybus_wrapper_fYi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    xillybus_wrapper_fYi_rom_U :  component xillybus_wrapper_fYi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
