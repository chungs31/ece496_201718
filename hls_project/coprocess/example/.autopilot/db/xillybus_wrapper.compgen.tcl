...
set ID 14
set MemName xillybus_wrapper_cud
...
set TrueReset 0
set IsROM 1
set ROMData { "1001000" "1100101" "1101100" "1101100" "1101111" "0101100" "0100000" "1110111" "1101111" "1110010" "1101100" "1100100" "0001010" "0000000" }
...
# Memory (RAM/ROM)  definition:
set ID 15
set MemName xillybus_wrapper_dEe
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 7
set AddrRange 4
...
set TrueReset 0
set IsROM 1
set ROMData { "1111000" "0110001" "0111101" "0000000" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
# Memory (RAM/ROM)  definition:
set ID 16
set MemName xillybus_wrapper_eOg
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 4
set AddrRange 2
...
# Memory (RAM/ROM)  definition:
set ID 17
set MemName xillybus_wrapper_fYi
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 100
set AddrRange 13
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_debug_ready \
    op interface \
    ports { debug_ready { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_debug_out \
    op interface \
    ports { debug_out { O 8 vector } debug_out_ap_vld { O 1 bit } } \
} "
}
