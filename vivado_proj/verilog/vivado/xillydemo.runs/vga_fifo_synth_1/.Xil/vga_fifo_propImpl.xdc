set_property SRC_FILE_INFO {cfile:c:/xillinux-eval-zedboard-2.0a/vivado-essentials/vga_fifo/vga_fifo_clocks.xdc rfile:../../../../../vivado-essentials/vga_fifo/vga_fifo_clocks.xdc id:1 order:LATE scoped_inst:U0} [current_design]
